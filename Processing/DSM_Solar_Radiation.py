...
def solar_radiation(input_file):
    ...
    cmd = "saga_cmd -f=s ta_lighting 2 -GRD_DEM={0} -GRD_DIRECT={1} -GRD_DIFFUS={2} -GRD_TOTAL={3} -DAY_A=0 -MON_A=6 -DAY_B=0 -MON_B=6 -DDAYS=1 -DHOUR=3.000 -HOUR_RANGE_MIN=5.000000 -HOUR_RANGE_MAX=20.000000 -METHOD=2".format(input_file, output_file_direct, output_file_diffus, output_file_totals)
    sb.call(cmd, shell=False)
    return output_file
